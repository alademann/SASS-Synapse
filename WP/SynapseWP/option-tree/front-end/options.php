  ...
  <div id="content_wrap">
    ...
    <form method="post" id="the-theme-options">
      ...
      <div class="info top-info is-option-page">
          ...
          <input type="submit" value="<?php _e('Save All Changes', 'localization'); ?>" class="button-framework save-options" name="submit" />

        <div class="top-layout-bar">

          <div class="save-layout-wrap">
            <input type="text" name="options_name" value="" id="save_theme_layout" />
            <input type="submit" value="<?php _e('New Layout', 'localization'); ?>" class="button-framework user-save-layout" name="user-save-layout" />
          </div>
          ...
          {
            ?>
         		<input type="submit" value="<?php _e('Activate Layout', 'localization'); ?>" class="button-framework user-activate-layout" name="user-activate-layout" style="margin-right:10px;" />
         		<?php
          ...
          <?php if ( $this->has_xml ) { ?>
          <input type="submit" value="<?php _e('Reload XML', 'localization'); ?>" class="button-framework reload-options right" name="reload" style="margin:5px 10px 0 20px;" />
          <?php } ?>
      ...
      <div class="info bottom">
          ...
          <input type="submit" value="<?php _e('Reset Options', 'localization'); ?>" class="button-framework reset" name="reset"/>
        <input type="submit" value="<?php _e('Save All Changes', 'localization'); ?>" class="button-framework save-options" name="submit"/>
